...
<svg width="0" height="0" class="hidden">
    ...
    <symbol fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 13" id="wet">
        <path d="M8 8.72906C8 11.0878 6.20814 13 3.99941 13C1.79067 13 0 11.0878 0 8.72906C0 6.37037 3.99941 0 3.99941 0C3.99941 0 8 6.37037 8 8.72906Z" fill="currentColor"></path>
    </symbol>
    ...
    <symbol fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43 31" id="sunrise">
        ...
        <path d="M12.1148 10.7005L6.88013 5.46582L5.46593 6.88002L10.7006 12.1147L12.1148 10.7005Z" fill="currentColor"></path>
...
<!-- <?php echo json_encode($forecatsArr[$i-1]) ?> -->
    ...
    <!-- <div class="informer2-blue__background-1"></div>  -->
        <!-- <div class="informer2-blue__background-2"></div>  -->
                    ...
                    <div class="informer2-blue__td-flexbox-middle">
                        <div class="informer2-blue__box-small-icons">
                            <svg viewBox="0 0 43 31" width="40%" height="40%">
                                <use fill="currentColor" xlink:href="#sunrise"/>
                            </svg>
                        </div>
                    ...
                    <div class="informer2-blue__td-flexbox-middle">
                        <div class="informer2-blue__box-small-icons">
                            <svg viewBox="0 0 43 32" width="40%" height="40%">
                                <use fill="currentColor" xlink:href="#sunset"/>
                            </svg>
                        </div>
                        <p class="informer2-blue__text-small">
                ...
                <td class="informer2-blue__td" colspan="3">
                    <div class="informer2-blue__td-flexbox-middle">
                        ...
                        <div class="informer2-blue__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[0], 'informer2-blue__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '80%', '100%') ?>
                        </div>
                        <p class="informer2-blue__text-big">
            ...
            <tr class="informer2-blue__tr">
                <td class="informer2-blue__td" colspan="3">
                    <div class="informer2-blue__td-flexbox-middle">
                        ...
                        <div class="informer2-blue__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[1], 'informer2-blue__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '80%', '100%') ?>
                        </div>
                        <p class="informer2-blue__text-big">
                ...
                <td class="informer2-blue__td" colspan="2" rowspan="2">
                    <div class="informer2-blue__td-flexbox-big">
                        <div class="informer2-blue__box-big-icons">
                            <?php echo $abstractData->getWeatherIcon($object, 'informer2-blue__box-gig-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr class="informer2-blue__tr">
                <td class="informer2-blue__td" colspan="3">
                    <div class="informer2-blue__td-flexbox-middle">
                        ...
                        <div class="informer2-blue__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[2], 'informer2-blue__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '80%', '100%') ?>
                        </div>
                        <p class="informer2-blue__text-big">
            ...
            <tr class="informer2-blue__tr">
                <td class="informer2-blue__td" colspan="3">
                    <div class="informer2-blue__td-flexbox-middle">
                        ...
                        <div class="informer2-blue__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[3], 'informer2-blue__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '80%', '100%') ?>
                        </div>
                        <p class="informer2-blue__text-big">
                    ...
                    <div class="informer2-blue__td-flexbox-small">
                        <div class="informer2-blue__box-small-icons">
                            <svg viewBox="0 0 33 24" width="70%" height="70%">
                                <use fill="currentColor" xlink:href="#speed-2"/>
                            </svg>
                        </div>
                        <p class="informer2-blue__text-small">
                            <span class="informer2__number-font"><?php echo $abstractData->getMetersPerSecond($object['ws']) ?> </span>
                    ...
                    <div class="informer2-blue__td-flexbox-small">
                        <div class="informer2-blue__box-small-icons">
                            <svg viewBox="0 0 8 12" width="40%" height="40%">
                                <use fill="currentColor" xlink:href="#dpf"/>
                            </svg>
                        </div>
                        <p class="informer2-blue__text-small">
            ...
            <tr class="informer2-blue__tr">
                <td class="informer2-blue__td" colspan="3">
                    <div class="informer2-blue__td-flexbox-middle">
                        ...
                        <div class="informer2-blue__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[4], 'informer2-blue__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '80%', '100%') ?>
                        </div>
                        <p class="informer2-blue__text-big">
                            <span class="informer2__number-font temp"><?php echo $forecatsArr[0]['tempC']; ?>°</span>
                        </p>
            ...
            <tr class="informer2-blue__tr">
                <td class="informer2-blue__td" colspan="3">
                    <div class="informer2-blue__td-flexbox-middle">
                        ...
                        <div class="informer2-blue__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[5], 'informer2-blue__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '80%', '100%') ?>
                        </div>
                        <p class="informer2-blue__text-big">
