...
<svg width="0" height="0" class="hidden">
    ...
    <symbol fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 14" id="grade">
        <path d="M7.5 0C3.36435 0 0 3.13992 0 7C0 10.8601 3.36435 14 7.5 14C11.6357 14 15 10.8601 15 7C15 3.13992 11.6357 0 7.5 0ZM8.5193 7.67377L4.88292 9.37055L6.55417 6.12637L10.1176 4.62894L8.5193 7.67377Z" fill="white"></path>
    </symbol>
    <symbol fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 18" id="wet-2">
        <path d="M12 12.0864C12 15.3523 9.31221 18 5.99911 18C2.68601 18 0 15.3523 0 12.0864C0 8.82051 5.99911 0 5.99911 0C5.99911 0 12 8.82051 12 12.0864Z" fill="white"></path>
    </symbol>
...
<div class="table-box">
    <div class="informer1-blue__background">
        <table class="informer1-blue">
            ...
            <tr class="informer1-blue__tr">
                <td class="informer1-blue__td informer1-blue__td-icons" >
                    <div class="informer1-blue__box-big-icons">
                        <?php echo $abstractData->getWeatherIcon($object, 'informer1-blue__box-middle-icons-img', '', '', '80%', '100%') ?>
                    </div>
                </td>
            </tr>
                    ...
                    <td class="informer1-blue__td">
                        ...
                        <div class="informer1-blue__td-flexbox-middle">
                            <div class="informer1-blue__box-middle-icons">
                                <?php echo $abstractData->getWeatherIcon($forecatsArr[$i], 'informer1-blue__box-middle-icons-img', '', '', '60%', '100%') ?>
                            </div>
                        </div>
                        <p class="informer1-blue__text-middle">
            ...
            <tr class="informer1-blue__background-1">
            </tr>
