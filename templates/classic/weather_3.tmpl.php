    ...
    <?php }?>
		...
		<tr class="informer3-blue__tr">
			...
			<td class="informer3-blue__td" colspan="2">
                ...
                <?php echo $abstractData->getWeatherIcon($object, 'informer3-blue__box-big-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                </div>
            </td>
		</tr>
		<tr class="informer3-blue__tr">
