...
<div class="informer4-table-box">
    ...
    <?php if($_REQUEST['transpar']=='1'){?>
        <img class="informer4-blue__background-1"src="<?php echo $abstractData->getWeatherBackground($forecatsArr[0],$abstractData->getDateFromString($forecatsArr[0]['dt'], 'H'))?>" width="20%" height="50%" alt="">

        <img class="informer4-blue__background-2"src="<?php echo $abstractData->getWeatherBackground($forecatsArr[1],$abstractData->getDateFromString($forecatsArr[1]['dt'], 'H'))?>" width="20%" height="50%" alt="">

        <img class="informer4-blue__background-3"src="<?php echo $abstractData->getWeatherBackground($forecatsArr[2],$abstractData->getDateFromString($forecatsArr[2]['dt'], 'H'))?>" width="20%" height="50%" alt="">

        <img class="informer4-blue__background-4"src="<?php echo $abstractData->getWeatherBackground($forecatsArr[3],$abstractData->getDateFromString($forecatsArr[3]['dt'], 'H'))?>" width="20%" height="50%" alt="">
    ...
    <div class="informer4-blue__background-5"></div>  <!-- ;) это не трогать-->
        ...
        <table class="informer4-blue">
            <tbody>
            <tr class="informer4-blue__tr">
                <td colspan="2" class="informer4-blue__td">
            ...
            <tr class="informer4-blue__tr">
                <td colspan="2" class="informer4-blue__td">
                    <div class="informer4-blue__td-flexbox-small">
                        <div class="informer4-blue__box-small-icons">
                            <svg  width="50%" height="50%" viewBox="0 0 16 16">
                                <use fill = "currentColor" xlink:href="#wind-route-2"/>
                            </svg>
                        </div>
                        <p class="informer4-blue__text-small informer4__text-font-light">
            ...
            <tr class="informer4-blue__tr">
                <td class="informer4-blue__td">
                    <div class="informer4-blue__td-flexbox-small">
                        <div class="informer4-blue__box-small-icons">
                            <svg width="50%" height="50%" viewBox="0 0 12 18">
                ...
                <td class="informer4-blue__td">
                    <div class="informer4-blue__td-flexbox-small">
                        <div class="informer4-blue__box-small-icons">
                            <svg width="50%" height="50%" viewBox="0 0 16 16">
                                <use fill = "currentColor" xlink:href="#degree-b"/>
                            </svg>
                        </div>
                        <p class="informer4-blue__text-small informer4__text-font-light">
                ...
                <td colspan="2" class="informer4-blue__td">
                    <div class="informer4-blue__td-flexbox-small">
                        <div class="informer4-blue__box-small-icons">
                            <svg width="55%" height="55%" viewBox="0 0 16 16">
            ...
            <tr class="informer4-blue__tr">
                <?php for ($i=0; $i < 4; $i++) {?>
                    <td class="informer4-blue__td">
                        <div class="informer4-blue__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[$i], 'informer4-blue__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                    </td>
                <?php }?>
            </tr>
