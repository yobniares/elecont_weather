                ...
                <?php for ($i=0; $i < 4; $i++) {?>
                    <td class="informer4-blue__td">
                        <div class="informer4-blue__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[$i], 'informer4-blue__box-middle-icons-img', '', '', '100%', '100%') ?>
                        </div>
                    </td>
                <?php }?>
            </tr>
