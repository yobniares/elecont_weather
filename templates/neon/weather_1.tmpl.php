...
<div class="table-box">
    ...
    <?php if($_REQUEST['transpar']=='1'){?>
        <img class="informer1-neon__background-3"src="<?php echo $abstractData->getWeatherBackground($object,date('H', time()))?>" width="100%" height="100%" alt="">
        ...
        <table class="informer1-neon">
            ...
            <tr class="informer1-neon__tr">
                <td class="informer1-neon__td informer1-neon__td-icons" >
                    <div class="informer1-neon__box-big-icons">
                        <?php echo $abstractData->getWeatherIcon($object, 'informer1-neon__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '80%', '100%') ?>
                    </div>
                </td>
            </tr>
                ...
                <td class="informer1-neon__td">
                    <div class="informer1-neon__td-flexbox-small">
                        <div class="informer1-neon__box-small-icons">
                            <svg viewBox="0 0 26 26" width="90%" height="90%">
            ...
            <tr class="informer1-neon__tr">
                <td class="informer1-neon__td">
                    <div class="informer1-neon__td-flexbox-small">
                        <div class="informer1-neon__box-small-icons">
                            <svg viewBox="0 0 33 24" width="100%" height="100%">
            ...
            <tr class="informer1-neon__tr">
                <td class="informer1-neon__td">
                    <div class="informer1-neon__td-flexbox-small">
                        <div class="informer1-neon__box-small-icons">
                            <svg  viewBox="0 0 12 18"  width="70%" height="70%">
            ...
            <tr class="informer1-neon__tr">
                <td class="informer1-neon__td">
                    <div class="informer1-neon__td-flexbox-small">
                        <div class="informer1-neon__box-small-icons" >
                            <svg viewBox="0 0 7 26" width="60%" height="60%">
                    ...
                    <td class="informer1-neon__td">
                        ...
                        <div class="informer1-neon__td-flexbox-middle">
                            <div class="informer1-neon__box-middle-icons">
                                <?php echo $abstractData->getWeatherIcon($forecatsArr[$i], 'informer1-neon__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '60%', '100%') ?>
                            </div>
                        </div>
