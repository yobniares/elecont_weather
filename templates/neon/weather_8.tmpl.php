...
<?php if (!empty($_REQUEST['weather_tip'])) {?>
    <style>
        ...
        /* Background */
        <?php
        if(isset($_REQUEST['color_fon']) && $_REQUEST['color_fon'] !=='#' && $_REQUEST['clear']=='0' && $_REQUEST['transpar']=='0') {?>
       ...
       <?php if($_REQUEST['clear']=='0'){?>
        ...
        <table class="informer8-neon">
            ...
            <tr class="informer8-neon__tr">
                <th colspan="6" class="informer8-neon__td">
                    <p class="informer8-neon__text-big">
                        ...
                        <span class="informer8-neon__text-font"><?php echo $abstractData->getWeek() ?>,</span>
                        <span class="informer8-neon__number-font"><?php echo $abstractData->getDate('d') ?></span>
            ...
            <tr class="informer8-neon__tr">
                ...
                <td  class="informer8-neon__td">
                    <div class="informer8-neon__td-flexbox-big">
                        <p class="informer8-neon__text-middle"><?php echo $abstractData->getTimesOfDay($time = date('H:i', time())) ?></p>
                        <div class="informer8-neon__box-big-icons">
                            <?php echo $abstractData->getWeatherIcon($object, 'informer8-neon__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                        <p class="informer8-neon__text-middle"><?php echo $abstractData->getWeatherDescription($object['icon']) ?></p>

                    </div>
                </td>
                <td class="informer8-neon__td">
                    <div class="informer8-neon__td-flexbox-small">
                        <div class="informer8-neon__box-small-icons">
                            <svg  viewBox="0 0 16 16">
                                <use fill="currentColor" xlink:href="#wind-route-2"/>
                            </svg>
                        </div>
                        <p class="informer8-neon__text-small">
                            <span class="informer8-neon__text-font"><?php echo $abstractData->getWwindDirection($mainObject['wd']) ?>:</span>
                            <span class="informer8-neon__number-font"><?php echo $abstractData->getMetersPerSecond($mainObject['ws']) ?>
                            <span class="informer8-neon__text-font">м/с</span>
                        </p>
                    </div>
                    <div class="informer8-neon__td-flexbox-small">
                        <div class="informer8-neon__box-small-icons">
                        ...
                        <p class="informer8-neon__text-small">
                            <span class="informer8-neon__number-font"><?php echo $mainObject['gmtMin'] ?>°</span>
                        </p>
                    </div>
                    <div class="informer8-neon__td-flexbox-small">
                        <div class="informer8-neon__box-small-icons">
                        ...
                        <p class="informer8-neon__text-small">
                            <span class="informer8-neon__text-font">Влажность</span>
                            <span class="informer8-neon__number-font"><?php echo $mainObject['rh'] ?>%</span>
                        </p>
                    </div>
                    <div class="informer8-neon__td-flexbox-small">
                        <div class="informer8-neon__box-small-icons">
                        ...
                        <p class="informer8-neon__text-small">
                            <span class="informer8-neon__text-font">Давление</span>
                            <span class="informer8-neon__number-font"><?php echo $abstractData->getMillimetersOfMercury($mainObject['psl']) ?></span>
                            <span class="informer8-neon__text-font">мм рт. ст.</span>
                        </p>
                    </div>
                    <div class="informer8-neon__td-flexbox-small">
                        <div class="informer8-neon__box-small-icons">
                        ...
                        <p class="informer8-neon__number-small">
                            <span class="informer8-neon__number-font">dpF <?php echo $mainObject['dpF'] ?>°</span>
                        </p>
                    </div>
                </td>
                <?php for ($i=0; $i < 3; $i++) { ?>
                    <td class="informer8-neon__td">
                        <div class="informer8-neon__td-flexbox-middle">
                            <p class="informer8-neon__text-middle"><?php echo $abstractData->getTimesOfDay($abstractData->getDateFromString($forecatsArr[$i]['dt'], 'H:i')) ?></p>
                            <div class="informer8-neon__box-middle-icons">
                                <?php echo $abstractData->getWeatherIcon($object, 'informer8-neon__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                            </div>
