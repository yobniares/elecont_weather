...
<?php if (!empty($_REQUEST['weather_tip'])) {?>
    <style>
        ...
        .informer4-neon__tr:nth-child(1) .informer1-blue__td:nth-child(1) {
...
<svg width="0" height="0" class="hidden">
    ...
    <symbol  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" id="degree-b">
        <path d="M8 0C3.58864 0 0 3.58848 0 8C0 12.4115 3.58864 16 8 16C12.4114 16 16 12.4115 16 8C16 3.58848 12.4114 0 8 0ZM9.08725 8.77002L5.20845 10.7092L6.99111 7.00157L10.7921 5.29021L9.08725 8.77002Z" ></path>
    </symbol>
        ...
        <table class="informer4-neon">
            ...
            <tr class="informer4-neon__tr">
                <td colspan="2" class="informer4-neon__td">
                    <p class="informer4-neon__text-big">
            ...
            <tr class="informer4-neon__tr">
                <td colspan="2" class="informer4-neon__td">
                    <p class="informer4-neon__text-middle">
            ...
            <tr class="informer4-neon__tr">
                <td colspan="2" class="informer4-neon__td">
                    <div class="informer4-neon__td-flexbox-small">
                        ...
                        <p class="informer4-neon__text-small">
            ...
            <tr class="informer4-neon__tr">
                ...
                <td class="informer4-neon__td">
                    <div class="informer4-neon__td-flexbox-small">
                        <div class="informer4-neon__box-small-icons">
                            <svg width="49%" height="49%" viewBox="0 0 16 16">
            ...
            <tr class="informer4-neon__tr">
                <?php for ($i=0; $i < 4; $i++) {?>
                    <td class="informer4-neon__td">
                        <div class="informer4-neon__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[$i], 'informer4-neon__box-middle-icons-img', '', '', '100%', '100%') ?>
                        </div>
                    </td>
                <?php }?>
            </tr>
            ...
            <tr class="informer4-neon__tr">
                ...
                <?php for ($i=0; $i < 4; $i++) {?>
                    <td class="informer4-neon__td" >
                        <p class="informer4-neon__text-big">
                            <span class="informer4__number-font informer4__number-font-bold informer4__number-font-time shine-neon temp"><?php echo $forecatsArr[$i]['tempC']; ?>°</span>
                        </p>
                        <p class="informer4-neon__text-middle">
                            <span class="informer4__number-font temp"><?php echo $forecatsArr[$i]['tempF']; ?>F</span>
                        </p>
                    </td>
                <?php }?>
            </tr>
