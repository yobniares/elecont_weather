...
<?php if($_REQUEST['clear']=='0'){?>
        ...
        <?php }?>
            ...
            <?php if($_REQUEST['transpar']=='1'){?>
                <img class="informer7-neon__background-5"src="<?php echo $abstractData->getWeatherBackground($object,date('H', time()))?>" width="100%" height="100%" alt="">
        ...
        <table class="informer7-neon">
            ...
            <tr class="informer7-neon__tr">
                <td rowspan="3" class="informer7-neon__td">
                    <div class="informer7-neon__td-flexbox-big">
                        <p class="informer7-neon__text-middle">GMT<?php echo '+' .$object['gmtMin']/60 ?></p>
                        <p class="informer7-neon__number-big  shine-neon"><?php echo $abstractData->getDate('H:i') ?></p>
                        <p class="informer7-neon__number-big-1 shine-neon"><?php echo $object['tempC'] ?>°</p>
                        <p class="informer7-neon__number-big-2 shine-neon"><?php echo $object['tempF'] ?>°F</p>
                    </div>
                </td>
                <td rowspan="3" class="informer7-neon__td">
                    <div class="informer7-neon__td-flexbox-big">
                        <p class="informer7-neon__text-middle"><?php echo $abstractData->getTimesOfDay($time = date('H:i', time())) ?></p>
                        <div class="informer7-neon__box-big-icons">
                            <?php echo $abstractData->getWeatherIcon($object, 'informer7-neon__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                    </div>
                </td>
                <td rowspan="3" class="informer7-neon__td">
                    ...
                    <div class="informer7-neon__td-flexbox-small">
                        ...
                        <p class="informer7-neon__text-small">
                            <span class="informer7-neon__text-font"><?php echo $abstractData->getWwindDirection($object['wd']) ?>:</span>
                            <span class="informer7-neon__number-font"><?php echo $abstractData->getMetersPerSecond($object['ws']) ?>
                            <span class="informer7-neon__text-font">м/с</span>
                        </p>
                    </div>
                    <div class="informer7-neon__td-flexbox-small">
                        <div class="informer7-neon__box-small-icons">
                        ...
                        <p class="informer7-neon__text-small">
                            <span class="informer7-neon__number-font"><?php echo $object['gmtMin'] ?>°</span>
                        </p>
                    </div>
                    <div class="informer7-neon__td-flexbox-small">
                        <div class="informer7-neon__box-small-icons">
                        ...
                        <p class="informer7-neon__text-small">
                            <span class="informer7-neon__text-font">Влажность</span>
                            <span class="informer7-neon__number-font"><?php echo $object['rh'] ?>%</span>
                        </p>
                    </div>
                    <div class="informer7-neon__td-flexbox-small">
                        <div class="informer7-neon__box-small-icons">
                        ...
                        <p class="informer7-neon__text-small">
                            <span class="informer7-neon__text-font">Давление</span>
                            <span class="informer7-neon__number-font"><?php echo $abstractData->getMillimetersOfMercury($object['psl']) ?></span>
                            <span class="informer7-neon__text-font">мм рт. ст.</span>
                        </p>
                    </div>
                    <div class="informer7-neon__td-flexbox-small">
                        <div class="informer7-neon__box-small-icons">
                        ...
                        <p class="informer7-neon__number-small">
                            <span class="informer7-neon__number-font">dpF <?php echo $mainObject['dpF'] ?>°</span>
                        </p>
                    </div>
                </td>
                ...
                if($i == 0) {
                ?>
                <td class="informer7-neon__td">
                    <p class="informer7-neon__text-middle"><?php echo $abstractData->getTimesOfDay($abstractData->getDateFromString($forecatsArr[$i]['dt'], 'H:i')) ?></p>
                </td>
                <td class="informer7-neon__td">
                    <div class="informer7-neon__box-middle-icons">
                        <?php echo $abstractData->getWeatherIcon($object, 'informer7-neon__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                    </div>
                </td>
                <td class="informer7-neon__td">
                    <p class="informer7-neon__number-middle">
                        <span class="informer7-neon__number-font"><?php echo $forecatsArr[$i]['tempC']; ?>°</span>
                    </p>
                </td>
            </tr>
            <?php
