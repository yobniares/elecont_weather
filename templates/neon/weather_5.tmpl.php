...
<?php if (!empty($_REQUEST['weather_tip'])) {?>
    <style>
        ...
        /* Background */
        <?php
        if(isset($_REQUEST['color_fon']) && $_REQUEST['color_fon'] !=='#' || $_REQUEST['color_fon'] !=='') {?>
        .informer5-neon__background-1,
        .informer5-neon__tr .informer5-neon__td {
        ...
        .informer5-neon__tr:nth-child(1) .informer1-blue__td:nth-child(1) {
        ...
        <?php
         if(isset($_REQUEST['font_tempo']) && $_REQUEST['font_tempo'] !=='#' || $_REQUEST['font_tempo'] !=='') {?>
        .temp {
            ...
            <tr class="informer5-neon__tr">
                ...
                <td colspan="2" class="informer5-neon__td">
                    <div class="informer5-neon__box-big-icons">
                        <?php echo $abstractData->getWeatherIcon($object, 'informer5-neon__box-big-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                    </div>
                ...
                <?php for ($i=0; $i < 3; $i++) {?>
                    <td colspan="2" class="informer5-neon__td">
                        ...
                        <div class="informer5-neon__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[$i], 'informer5-neon__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
