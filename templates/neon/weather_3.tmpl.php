            ...
            <tr class="informer3-neon__tr">
                ...
                <td class="informer3-neon__td" colspan="2">
                    <div class="informer3-neon__box-big-icons">
                        <?php echo $abstractData->getWeatherIcon($object, 'informer3-neon__box-big-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                    </div>
                </td>
            </tr>
            <tr class="informer3-neon__tr">
            ...
            <tr class="informer3-neon__tr">
                ...
                <td colspan="2" class="informer3-neon__td">
                    <div class="informer3-neon__box-middle-icons">
                        <?php echo $abstractData->getWeatherIcon($forecatsArr[$i], 'informer3-neon__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                    </div>
                </td>
            </tr>
            <?php
