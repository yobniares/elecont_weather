...
<table  align="center"  class="compakt litl" style="background-color:#ffffff" bgcolor="#dcdcdc">
    <tr><td width="30%" rowspan="2" class="den_nedeli">
        ...
        <td width="20%" style="border: 2px solid #999999; border-radius: 20px; background-color: #0000001f;">
            <p class="tempo" style=" line-height: 100px;"><?php echo $object['tempC'] ?>&deg;
                <img src='assets/img/<?php if(!empty($_REQUEST['weather_tip_img'])) {echo $_REQUEST['weather_tip_img'];} else{echo 'img_7_svg';} ?>/icon_<?php echo $object['icon'] ?>.svg' style="float: right; max-width: 45%;" />
            </p>
        ...
        <?php for ($i=0; $i < 3; $i++) {?>
            <td width="16%">
                ...
                {echo $_REQUEST['weather_tip_img'];} else{echo 'img_7_svg';} ?>/icon_<?php echo $forecatsArr[$i]['icon'] ?>.svg' style="max-width: 30%;" />
