...
<?php if (!empty($_REQUEST['weather_tip'])) {?>
    <style>
        ...
        .informer2-grey__tr:nth-child(1) .informer1-blue__td:nth-child(1) {
                ...
                <td class="informer2-grey__td" colspan="3">
                    <div class="informer2-grey__td-flexbox-middle">
                        ...
                        <div class="informer2-grey__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[0], 'informer2-grey__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                        <p class="informer2-grey__text-big">
            ...
            <tr class="informer2-grey__tr">
                <td class="informer2-grey__td" colspan="3">
                    <div class="informer2-grey__td-flexbox-middle">
                        ...
                        <div class="informer2-grey__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[1], 'informer2-grey__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                        <p class="informer2-grey__text-big">
                ...
                <td class="informer2-grey__td" rowspan="2">
                    <p class="informer2-grey__text-big">
                        <span class="informer2__number-font informer2__number-font-bold temp"><?php echo $object['tempC']; ?>°</span>
                    </p>
                </td>
                <td class="informer2-grey__td" colspan="2" rowspan="2">
                    <div class="informer2-grey__td-flexbox-big">
                        <div class="informer2-grey__box-big-icons">
                            <?php echo $abstractData->getWeatherIcon($object, 'informer2-grey__box-big-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                    </div>
                </td>
            </tr>
            <tr class="informer2-grey__tr">
                <td class="informer2-grey__td" colspan="3">
                    <div class="informer2-grey__td-flexbox-middle">
                        ...
                        <div class="informer2-grey__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[2], 'informer2-grey__box-big-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                        <p class="informer2-grey__text-big">
            ...
            <tr class="informer2-grey__tr">
                <td class="informer2-grey__td" colspan="3">
                    <div class="informer2-grey__td-flexbox-middle">
                        ...
                        <div class="informer2-grey__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[3], 'informer2-grey__box-big-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                        <p class="informer2-grey__text-big">
                ...
                <td class="informer2-grey__td" colspan="2" rowspan="2">
                    ...
                    <div class="informer2-grey__td-flexbox-small">
                        <div class="informer2-grey__box-small-icons">
                            <svg width="45%" height="45%">
                                <use fill="currentColor"xlink:href="#wet-1-b"/>
                            </svg>
                    ...
                    <div class="informer2-grey__td-flexbox-small">
                        <div class="informer2-grey__box-small-icons">
                            <svg width="40%" height="40%">
                                <use fill="currentColor"xlink:href="#dpf-black"/>
                            </svg>
                        </div>
                        <p class="informer2-grey__text-small">
            ...
            <tr class="informer2-grey__tr">
                <td class="informer2-grey__td" colspan="3">
                    <div class="informer2-grey__td-flexbox-middle">
                        ...
                        <div class="informer2-grey__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[4], 'informer2-grey__box-big-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                        <p class="informer2-grey__text-big">
                            <span class="informer2__number-font informer2__number-font-bold temp"><?php echo $forecatsArr[4]['tempC']; ?>°</span>
                        </p>
                    </div>
                </td>
            </tr>
            <tr class="informer2-grey__tr">
                <td class="informer2-grey__td" colspan="3">
                    <div class="informer2-grey__td-flexbox-middle">
                        ...
                        <div class="informer2-grey__box-middle-icons">
                            <?php echo $abstractData->getWeatherIcon($forecatsArr[5], 'informer2-grey__box-big-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                        <p class="informer2-grey__text-big">
