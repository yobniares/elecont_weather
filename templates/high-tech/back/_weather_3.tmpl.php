...
<body>
    <section class="view-3-ht-container">
        <div class="view-3-ht-1 <?php if ($_REQUEST['transpar'] == 1) {
    echo 'view-3-ht-2';
} ?>">
            <div class="view-3-ht-top <?php if ($_REQUEST['transpar'] == '') {
    echo 'black-icons';
} ?>">
                <p class="view-3-ht-city <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
                    <?php echo $object['name'] ?>
                </p>
                <p class="view-3-ht-selected-timeofday <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
                    <?php echo $abstractData->getTimesOfDay($time = date('H:i', time())) ?>
                </p>
                <p class="view-3-ht-daynumber <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
                    <?php echo $abstractData->getDate('d.m.Y') ?>
                </p>
                <p class="view-3-ht-weekday <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
    ...
    echo $abstractData->getWeatherIcon($object, '');
                ...
                <div class="view-3-ht-temp <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
                ...
                <div class="view-3-ht-params <?php if ($_REQUEST['transpar'] == '') {
    echo 'black-icons';
} ?>">
                    <p class="view-3-ht-typeofwind <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
                        <?php echo $abstractData->getWwindDirection($object['wd']) ?>
                    </p>
                    <p class="view-3-ht-windspeed <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
                        <?php echo $abstractData->getMetersPerSecond($object['ws']) ?> м/с
                    </p>
                    <p class="view-3-ht-degree <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
                        <?php echo $object['gmtMin'] ?>°
                    </p>
                    <p class="view-3-ht-wet <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
                        Влажность:<?php echo $object['rh'] ?>%
                    </p>
                    <p class="view-3-ht-pressure <?php if ($_REQUEST['transpar'] == 1) {
    echo 'white-font';
} ?>">
