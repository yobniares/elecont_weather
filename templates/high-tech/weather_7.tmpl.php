...
<div class="informer7-table-box">
    ...
    <?php if($_REQUEST['clear']=='0'){?>
        ...
        <div class="informer7-grey__background-6"></div>


        <table class="informer7-grey">
            <tbody>
            <tr class="informer7-grey__tr">
                ...
                <td rowspan="3" class="informer7-grey__td">
                    <div class="informer7-grey__td-flexbox-big">
                        <p class="informer7-grey__text-middle"><?php echo $abstractData->getTimesOfDay($time = date('H:i', time())) ?></p>
                        <div class="informer7-grey__box-big-icons">
                            <?php echo $abstractData->getWeatherIcon($object, 'informer7-blue__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                    </div>
                </td>
                <td rowspan="3" class="informer7-grey__td">
                    <div class="informer7-grey__td-flexbox-small">
                        <div class="informer7-grey__box-small-icons">
                            <svg viewBox="0 0 26 36" width="45%" height="45%">
                                <use fill="currentColor" xlink:href="#place"/>
                            </svg>
                        </div>
                        <p class="informer7-grey__text-small">
                            <span class="informer7-grey__text-font"><?php echo $object['name'] ?><span>
                            <span class="informer7-grey__text-font"><?php echo $abstractData->getWeatherDescription($object['icon']) ?><span>
                        </p>
                    </div>
                    <div class="informer7-grey__td-flexbox-small">
                        <div class="informer7-grey__box-small-icons">
                        ...
                        <p class="informer7-grey__text-small">
                            <span class="informer7-grey__text-font"><?php echo $abstractData->getWwindDirection($object['wd']) ?>:</span>
                            <span class="informer7-grey__number-font"><?php echo $abstractData->getMetersPerSecond($object['ws']) ?>
                            <span class="informer7-grey__text-font">м/с</span>
                        </p>
                    </div>
                    <div class="informer7-grey__td-flexbox-small">
                        <div class="informer7-grey__box-small-icons">
                        ...
                        <p class="informer7-grey__text-small">
                            <span class="informer7-grey__number-font"><?php echo $object['gmtMin'] ?>°</span>
                        </p>
                    </div>
                    <div class="informer7-grey__td-flexbox-small">
                        <div class="informer7-grey__box-small-icons">
                        ...
                        <p class="informer7-grey__text-small">
                            <span class="informer7-grey__text-font">Влажность</span>
                            <span class="informer7-grey__number-font"><?php echo $object['rh'] ?>%</span>
                        </p>
                    </div>
                    <div class="informer7-grey__td-flexbox-small">
                        <div class="informer7-grey__box-small-icons">
                        ...
                        <p class="informer7-grey__text-small">
                            <span class="informer7-grey__text-font">Давление</span>
                            <span class="informer7-grey__number-font"><?php echo $abstractData->getMillimetersOfMercury($object['psl']) ?></span>
                            <span class="informer7-grey__text-font">мм рт. ст.</span>
                        </p>
                    </div>
                    <div class="informer7-grey__td-flexbox-small">
                        <div class="informer7-grey__box-small-icons">
                        ...
                        <p class="informer7-grey__number-small">
                            <span class="informer7-grey__number-font">dpF <?php echo $mainObject['dpF'] ?>°</span>
                        </p>
                    </div>
                </td>
                ...
                <td class="informer7-grey__td">
                    <p class="informer7-grey__text-middle"><?php echo $abstractData->getTimesOfDay($abstractData->getDateFromString($forecatsArr[$i]['dt'], 'H:i')) ?></p>
                </td>
                <td class="informer7-grey__td">
                    <div class="informer7-grey__box-middle-icons">
                        <?php echo $abstractData->getWeatherIcon($object, 'informer7-blue__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                    </div>
                </td>
                <td class="informer7-grey__td">
