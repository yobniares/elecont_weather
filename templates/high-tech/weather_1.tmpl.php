...
<svg width="0" height="0" class="hidden">
    ...
    <symbol fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 18" id="wet-b-2">
        <path d="M12 12.0864C12 15.3523 9.31221 18 5.99911 18C2.68601 18 0 15.3523 0 12.0864C0 8.82051 5.99911 0 5.99911 0C5.99911 0 12 8.82051 12 12.0864Z" fill="black"></path>
    </symbol>
                    ...
                    <td class="informer1-grey__td">
                        ...
                        <div class="informer1-grey__td-flexbox-middle">
                            <div class="informer1-grey__box-middle-icons">
                                <?php echo $abstractData->getWeatherIcon($forecatsArr[$i], 'informer1-grey__box-middle-icons-img', '', '', '60%', '100%') ?>
                            </div>
                        </div>
                        <p class="informer1-grey__text-middle">
