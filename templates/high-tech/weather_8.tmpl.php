...
<div class="informer8__table-box">
    ...
    <?php if($_REQUEST['clear']=='0'){?>
        ...
        <table class="informer8-grey">
            ...
            <tr class="informer8-grey__tr">
                <td rowspan="3" class="informer8-grey__td">
                    <div class="informer8-grey__box-small-icons">
                        <svg viewBox="0 0 26 36">
                            <use fill="currentColor" xlink:href="#place"/>
                        </svg>
                    </div>
                    <p class="informer8-grey__text-small">
                        <span class="informer8-grey__text-font"><?php echo $mainObject['name'] ?></span>
                    </p>
                    <p class="informer8-grey__number-big"><?php echo $abstractData->getDate('H:i') ?></p>
                    <p class="informer8-grey__text-middle"><?php echo $abstractData->getWeek() ?></p>
                </td>
                ...
                <td rowspan="3" class="informer8-grey__td">
                    <div class="informer8-grey__td-flexbox-big">
                        <p class="informer8-grey__text-middle"><?php echo $abstractData->getTimesOfDay($time = date('H:i', time())) ?></p>
                        <div class="informer8-grey__box-big-icons">
                            <?php echo $abstractData->getWeatherIcon($object, 'informer8-grey__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                        </div>
                    </div>
                </td>
                <td rowspan="3" class="informer8-grey__td">
                    <div class="informer8-grey__td-flexbox-small">
                        <div class="informer8-grey__box-small-icons">
                        ...
                        <p class="informer8-grey__text-small">
                            <span class="informer8-grey__text-font"><?php echo $abstractData->getWwindDirection($mainObject['wd']) ?>:</span>
                            <span class="informer8-grey__number-font"><?php echo $abstractData->getMetersPerSecond($mainObject['ws']) ?></span>
                            <span class="informer8-grey__text-font">м/с</span>
                        </p>
                    </div>
                    <div class="informer8-grey__td-flexbox-small">
                        <div class="informer8-grey__box-small-icons">
                        ...
                        <p class="informer8-grey__text-small">
                            <span class="informer8-grey__number-font"><?php echo $mainObject['gmtMin'] ?>°</span>
                        </p>
                    </div>
                    <div class="informer8-grey__td-flexbox-small">
                        <div class="informer8-grey__box-small-icons">
                        ...
                        <p class="informer8-grey__text-small">
                            <span class="informer8-grey__text-font">Влажность</span>
                            <span class="informer8-grey__number-font"><?php echo $mainObject['rh'] ?>%</span>
                        </p>
                    </div>
                    <div class="informer8-grey__td-flexbox-small">
                        <div class="informer8-grey__box-small-icons">
                        ...
                        <p class="informer8-grey__text-small">
                            <span class="informer8-grey__text-font">Давление</span>
                            <span class="informer8-grey__number-font"><?php echo $abstractData->getMillimetersOfMercury($mainObject['psl']) ?></span>
                            <span class="informer8-grey__text-font">мм рт. ст.</span>
                        </p>
                    </div>
                    <div class="informer8-grey__td-flexbox-small">
                        <div class="informer8-grey__box-small-icons">
                        ...
                        <p class="informer8-grey__number-small">
                            <span class="informer8-grey__number-font">dpF <?php echo $mainObject['dpF'] ?>°</span>
                        </p>
                    </div>
                </td>
                ...
                <td class="informer8-grey__td">
                    <p class="informer8-grey__text-middle"><?php echo $abstractData->getTimesOfDay($abstractData->getDateFromString($forecatsArr[$i]['dt'], 'H:i')) ?></p>
                </td>

                <td class="informer8-grey__td">
                    <div class="informer8-grey__box-middle-icons">
                        <?php echo $abstractData->getWeatherIcon($object, 'informer8-grey__box-middle-icons-img', '', 'filter: url(#recolourFilter);', '100%', '100%') ?>
                    </div>
                </td>
                <td class="informer8-grey__td">
